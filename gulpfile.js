...
gulp.task('default',function(){
    ...
    console.log('| * build:nojs -> Transpiles everything except javascript.|');
    ...
    console.log('| * serve: Starts server for produced files on localhost. |');
    console.log('|=========================================================|');
    console.log('|                 -- Supporting tasks --                  |');
    console.log('|=========================================================|');
    ...
    console.log('| * clean:(html, css, js, fonts, img) -> Specific clean   |');
    console.log('===========================================================');
})